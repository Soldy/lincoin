...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("lincoin.sipa.be", "seed.lincoin.sipa.be"));
        vSeeds.push_back(CDNSSeedData("bluematt.me", "dnsseed.bluematt.me"));
        vSeeds.push_back(CDNSSeedData("dashjr.org", "dnsseed.lincoin.dashjr.org"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("lincoin.petertodd.org", "testnet-seed.lincoin.petertodd.org"));
